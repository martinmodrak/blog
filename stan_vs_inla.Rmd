...
Pleas let me know (via an [issue on GitHub](https://github.com/martinmodrak/stan_vs_inla/issues)) should you find any error or anything else that should be included in this post.
...
*Note on running the code: Installing RStan is unfortunately not as straightforward as running install.packages. Please consult https://github.com/stan-dev/rstan/wiki/RStan-Getting-Started if you don't have RStan already installed.*
