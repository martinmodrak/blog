...
6) Try *non-centered parametrization* - this is a special case of reparametrization that is so frequently useful that it deserves its own bullet. [Example - divergences and bias in a multilevel model
