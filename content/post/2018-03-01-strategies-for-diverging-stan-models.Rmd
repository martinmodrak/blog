...
5) Make sure your model is *identifiable* - non-identifiability and/or multimodality (multiple local maxima of the posterior distributions) is a problem. [Case study - mixture models](http://mc-stan.org/users/documentation/case-studies/identifying_mixture_models.html).
